...
Pod::Spec.new do |s|
  ...
  s.version          = '0.1.0'
  s.summary          = 'A short description of NGImagePicker.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/<GITHUB_USERNAME>/NGImagePicker'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'Nicolas Goossaert' => 'nicolas.goossaert@bewoopi.net' }
  s.source           = { :git => 'https://github.com/<GITHUB_USERNAME>/NGImagePicker.git', :tag => s.version.to_s }
